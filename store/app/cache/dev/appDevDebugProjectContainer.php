...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'alittlejewerly', 'user' => 'root', 'password' => 'troiswa', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Store/BackendBundle/Entity'))), 'Store\\BackendBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('StoreBackendBundle' => 'Store\\BackendBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_95bee0aac5dd056369c18a27e0fa21d56911c255728955c4e6086cc52cb783b8');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('Ddgg6g5h4ssdghjl548efsKlfdf58jKd');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'fr',
            'secret' => 'Ddgg6g5h4ssdghjl548efsKlfdf58jKd',
            ...
            'kernel.secret' => 'Ddgg6g5h4ssdghjl548efsKlfdf58jKd',
